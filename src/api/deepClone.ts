 ...
 * 
 * Custom version build for Mapcraft ecosystem
 */
...
/**
 * The base implementation of `_.clone` and `_.deepClone` which tracks
 * traversed objects.
 *
 * @private
...
function baseIsNative(value) {
	...
	const pattern = (isFunction(value) || isHostObject(value))
		? reIsNative
		: reIsHostCtor;
