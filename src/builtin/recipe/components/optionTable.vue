<template>
	<div class="q-ma-md">
		<span class="text-h6 q-pb-sm">Option</span>
		<q-separator />
	</div>
	<div class="row justify-evenly q-ma-md">
		<div class="column justify-center items-center">
			<span class="text-body1">Shapeless</span>
			<q-toggle v-model="data.shapeless" size="xl" color="primary" />
		</div>
		<div v-if="!data.shapeless" class="column justify-center items-center">
			<span class="text-body1">Exact position</span>
			<q-toggle v-model="data.exactPosition" size="xl" color="primary" />
		</div>
		<div class="column justify-center items-center">
